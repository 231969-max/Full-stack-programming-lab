...
export default async function ProductsPage() {
  ...
  if (!products || products.length === 0) {
    products = [
      ...
      { _id: "4", title: "Fallback Leather Sofa", price: 499.99, imageUrl: "https://images.unsplash.com/photo-1493663284031-b7e3aefcae8e?w=500&h=500&fit=crop", category: "sofas", type: "popular" },
    ];
  }
    ...
    <div className="bg-gray-50 min-h-screen pb-20">
      <div className="bg-[#fdfaf3] py-16 border-b border-orange-100">
        <div className="container mx-auto px-4 text-center">
          <h1 className="text-4xl md:text-5xl font-serif text-gray-800 mb-4">All Products</h1>
          <p className="text-gray-600 max-w-2xl mx-auto">Explore our entire collection of premium, handcrafted furniture designed to elevate your living space.</p>
        </div>
      </div>
